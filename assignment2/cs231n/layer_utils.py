...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param):
    '''
    Convenience layer that performs affine transform followed by a bacth normalization
    layer then a ReLu layer

    Inputs:
    -x: Input to the affine layer
    -w,b: weights for the affine layer
    -gamma, beta: scaling and shifting parameters for batch normalization
    ...
    Returns a tuple of:
    - out: output after affine-bn-relu
    - cache: object to give to the backward pass
    '''
...
def affine_batchnorm_relu_backward(dout, cache):
    ...
    Inputs:
    -dout: gradient output from upper layers
    -cache: objects from the forward pass

    Return:
    -gradients w.r.t learnable parameters:dx, dw, db, dgamma, dbeta
    '''
